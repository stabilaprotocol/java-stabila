...
public class UcrWhenRequireStyleTest {

  private Manager dbManager;
  private StabilaApplicationContext context;
  private DepositImpl deposit;
  private String dbPath = "output_UcrWhenRequireStyleTest";
  ...
  public void requireTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testRequire()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thisFunctionViaMessageCallTest()
    ...
    long expectUcrUsageTotal = 57905;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectUcrUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testThisFunctionViaMessageCall()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);

    long expectUcrUsageTotal2 = 5339;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
  ...
  public void thatFunctionViaMessageCallTest()
    ...
    long expectUcrUsageTotal = 97341;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectUcrUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testThatFunctionViaMessageCall()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);

    long expectUcrUsageTotal2 = 64125;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
  ...
  public void newContractTest1()
    ...
    long expectUcrUsageTotal = 42687;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectUcrUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testNewContract()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
    ...
    Assert
        .assertTrue(result.getRuntime().getResult().getException() instanceof OutOfUcrException);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectUcrUsageTotal + expectUcrUsageTotal2) * 100);
  ...
  public void receiveStbWithoutPayableTest()
    ...
    result = SvmTestUtils
        .deployContractAndReturnSvmTestResult(contractName, address, ABI, code, 0, feeLimit,
            consumeUserResourcePercent, libraryAddressPair, dbManager, null);
    byte[] contractAddress = result.getContractAddress();
    long expectUcrUsageTotal2 = 100341;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal2);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectUcrUsageTotal + expectUcrUsageTotal2) * 100);
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testFallback()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 10, feeLimit, dbManager, null);

    long expectUcrUsageTotal3 = 51833;
  ...
  public void transferTest()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException {
    // done in UcrWhenSendAndTransferTest
  ...
  public void revertTest()
    ...
    long expectUcrUsageTotal = 36481;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - expectUcrUsageTotal * 100);
    byte[] contractAddress = result.getContractAddress();
    ...
    /* ====================================================================== */
    byte[] triggerData = SvmTestUtils.parseAbi("testRevert()", null);
    result = SvmTestUtils
        .triggerContractAndReturnSvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);

    long expectUcrUsageTotal2 = 146;
    Assert.assertEquals(result.getReceipt().getUcrUsageTotal(), expectUcrUsageTotal2);
    Assert.assertEquals(result.getRuntime().getResult().isRevert(), true);
    Assert.assertTrue(result.getRuntime().getResult().getException() == null);
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
