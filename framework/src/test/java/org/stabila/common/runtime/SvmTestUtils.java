...
public class SvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction stb = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(stb, deposit, block);
    return WalletUtil.generateContractAddress(stb);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
    ...
    return processTransactionAndReturnRuntime(stb, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule stbCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = stbCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = stbCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction stb = transactionBuilder.build();
    return stb;
  }
  ...
  public static Transaction generateDeploySmartContractWithCreatorUcrLimitAndGetTransaction(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      String libraryAddressPair, long creatorUcrLimit) {

    CreateSmartContract contract = buildCreateSmartContractWithCreatorUcrLimit(contractName,
        callerAddress, abi, code,
        value, consumeUserResourcePercent, libraryAddressPair, creatorUcrLimit);
    TransactionCapsule stbCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = stbCapWithoutFeeLimit.getInstance().toBuilder();
    Transaction.raw.Builder rawBuilder = stbCapWithoutFeeLimit.getInstance().getRawData()
  ...
  public static Runtime processTransactionAndReturnRuntime(Transaction stb,
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction stb,
  ...
  public static SVMTestResult deployContractAndReturnSvmTestResult(String contractName,
    ...
    return processTransactionAndReturnSvmTestResult(stb, dbManager, blockCap)
        .setContractAddress(WalletUtil.generateContractAddress(stb));
  }

  public static SVMTestResult deployContractWithCreatorUcrLimitAndReturnSvmTestResult(
      String contractName,
      byte[] callerAddress,
      String abi, String code, long value, long feeLimit, long consumeUserResourcePercent,
      String libraryAddressPair, Manager dbManager, BlockCapsule blockCap, long creatorUcrLimit)
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction stb = generateDeploySmartContractWithCreatorUcrLimitAndGetTransaction(
        contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair, creatorUcrLimit);
  ...
  public static SVMTestResult processTransactionAndReturnSvmTestResult(Transaction stb,
  ...
  public static CreateSmartContract buildCreateSmartContract(String contractName,
    ...
    builder.setOriginUcrLimit(engeryLimit);
  ...
  public static CreateSmartContract buildCreateSmartContractWithCreatorUcrLimit(
      String contractName,
      byte[] address,
      String abiString, String code, long value, long consumeUserResourcePercent,
      String libraryAddressPair, long creatorUcrLimit) {
    ...
    builder.setAbi(abi);
    builder.setConsumeUserResourcePercent(consumeUserResourcePercent);
    builder.setOriginUcrLimit(creatorUcrLimit);
