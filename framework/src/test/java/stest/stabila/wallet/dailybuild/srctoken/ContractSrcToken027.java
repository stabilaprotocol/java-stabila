...
@Slf4j
public class ContractSrcToken027 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String filePath = "src/test/resources/soliditycode/contractSrcToken027.sol";
    ...
    btestAddress = PublicMethed
        .deployContract(contractName, abi, code, "", maxFeeLimit,
            0L, 0, originUcrLimit, assetAccountId.toStringUtf8(),
  ...
  public void deploy02TransferTokenContract() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "testIndelegateCall(address,address,address,uint256,srcToken)",
