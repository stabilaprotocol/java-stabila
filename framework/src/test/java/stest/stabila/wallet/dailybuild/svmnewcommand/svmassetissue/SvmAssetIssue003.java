package stest.stabila.wallet.dailybuild.svmnewcommand.svmassetissue;
...
public class SvmAssetIssue003 {
  ...
  public void updateAsset001IllegalParameterVerification() {
    ...
    String filePath = "./src/test/resources/soliditycode/svmAssetIssue001.sol";
    String contractName = "svmAssetIssue001";
  ...
  public void updateAsset002CalledMultipleTimesInOneContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/svmAssetIssue002.sol";
    String contractName = "svmAssetIssue002";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    long callvalue = 1024000000L;
    ...
    Optional<TransactionInfo> infoById = PublicMethed
        .getTransactionInfoById(deployTxid, blockingStubFull);
    logger.info("infoById: " + infoById.get().getReceipt().getUcrUsageTotal());
    if (deployTxid == null || infoById.get().getResultValue() != 0) {
      Assert.fail("deploy transaction failed with message: " + infoById.get().getResMessage()
          .toStringUtf8());
    }
  ...
  public void updateAsset003Revert() {
    ...
    String filePath = "./src/test/resources/soliditycode/svmAssetIssue003.sol";
    String contractName = "svmAssetIssue003";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void updateAsset004CallAnotherInOneContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/svmAssetIssue004.sol";
    String contractName = "svmAssetIssue004";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
