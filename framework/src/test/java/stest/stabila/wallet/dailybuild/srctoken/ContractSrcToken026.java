...
@Slf4j
public class ContractSrcToken026 {
  ...
  public void deploy01TransferTokenContract001() {
    ...
    String filePath = "src/test/resources/soliditycode/contractSrcToken026.sol";
  ...
  public void deploy02TransferTokenContract002() {
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "testInCall(address,address,address,uint256,srcToken)",
