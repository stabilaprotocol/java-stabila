...
@Slf4j
public class ContractSrcToken041 {
  ...
  public void deployTransferTokenContract() {
    ...
    // cd balance
    PublicMethed.cdBalanceGetUcr(dev001Address, 204800000,
        0, 1, dev001Key, blockingStubFull);

    PublicMethed.cdBalanceGetUcr(user001Address, 2048000000,
    ...
    String filePath = "src/test/resources/soliditycode/contractSrcToken041.sol";
