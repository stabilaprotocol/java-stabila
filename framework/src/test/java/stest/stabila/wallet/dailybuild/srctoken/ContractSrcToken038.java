...
@Slf4j
public class ContractSrcToken038 {
  ...
  public void deployTransferTokenContract() {
    ...
    String filePath = "src/test/resources/soliditycode/contractSrcToken038.sol";
    String contractName2 = "transferSrc10";
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethed.unCdBalance(dev001Address, dev001Key, 1, null, blockingStubFull);
    if (channelFull != null) {
