package stest.stabila.wallet.dailybuild.svmnewcommand.istanbul;

import static org.stabila.protos.Protocol.Transaction.Result.contractResult.OUT_OF_TIME;
...
public class AltbnTest001 {
  ...
  @Test(enabled = true, description = "bn256add ucrCost reduced from 500 to 150")
  public void bn256addTest001() {
    ...
    long ucrCost = option.getReceipt().getUcrUsageTotal();
    logger.info("ucrCost: " + ucrCost);

    Assert.assertEquals(0,option.getResultValue());
  }

  @Test(enabled = true, description = "bn256add ucrCost reduced from 40000 to 6000")
  public void bn256ScalarMulTest001() {
    ...
    Assert.assertEquals(0,option.getResultValue());
    Assert.assertTrue(ucrCost < 40000L);
    Assert.assertTrue(ucrCost > 6000L);
  }

  @Test(enabled = true, description = "bn256add ucrCost reduced from ( 80000 * pairNum + 100000)"
  ...
  public void bn256paringTest001() {
    ...
    Assert.assertEquals(0,option.getResultValue());
    Assert.assertTrue(ucrCost < 80000L * 2 + 100000L);
    Assert.assertTrue(ucrCost > 34000L * 2 + 45000L);
  }
