...
@Slf4j
public class ContractSrcToken018 {
  ...
  public void testDeployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractSrcToken023.sol";
    ...
    final String triggerTxid = PublicMethed
        .triggerContract(transferTokenContractAddress, "TransferTokenTo(address,srcToken,uint256)",
