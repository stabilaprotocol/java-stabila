...
public class MarketSellAsset005 {
  ...
  @Test(enabled = true,description = "Create an order to sell Stb and buy Src10")
  void test01SellStbBuySrc10() {
  ...
  @Test(enabled = true,description = "Create an order to sell Src10 and buy Stb")
  void test02SellSrc10BuyStb() {
    long balanceAfter = PublicMethed.queryAccount(testKey001, blockingStubFull).getBalance();
