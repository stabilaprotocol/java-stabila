...
@Slf4j
public class ContractSrcToken036 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    //    String filePath = "src/test/resources/soliditycode/contractSrcToken036.sol";
  ...
  public void deploy03TransferTokenContract() {
    ...
    logger.info("beforeUcrUsed:" + beforeUcrUsed1);
  ...
  public void deploy04TransferTokenContract() {
    String filePath2 = "src/test/resources/soliditycode/contractSrcToken036.sol";
  ...
  public void deploy05TransferTokenContract() {
    ...
    logger.info("beforeUcrUsed:" + beforeUcrUsed3);
