package stest.stabila.wallet.dailybuild.svmnewcommand.validatemultisign;
...
public class TestValidatemultisign002 {
  ...
  public void test001DeployContract() {
    ...
    Assert.assertTrue(PublicMethed.cdBalanceForReceiver(fromAddress, 100_000_000L,
    ...
    Long beforeUcrUsed = accountResource.getUcrUsed();
