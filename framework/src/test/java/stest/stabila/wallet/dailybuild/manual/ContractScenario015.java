...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "STABILA SRC20 transfer token")
  public void src20Stabila() {
    ...
    String contractName = "STABILA SRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_SRC20_STABILA");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_SRC20_STABILA");
