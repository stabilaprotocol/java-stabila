...
public class StakeSuicideTest005 {
  ...
  @Test(enabled = false, description = "targetAddress is account no STB, and no cded")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 STB, and no cded")
  ...
  @Test(enabled = false, description = "targetAddress is account 1 STB, and 1 cded")
  void svmStakeSuicideTest003() {
    ...
    Assert.assertEquals(targetCdedBefore,targetCdedAfter);
    Assert.assertEquals(ownerBalance,targetBalance);
