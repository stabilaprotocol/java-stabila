...
public class Create2Test018 {
  ...
  public void beforeClass() {
    ...
    PublicMethed.printAddress(executiveKey001);
  }
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(PublicMethed.sendcoin(executiveAddress001, 100_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  @Test(enabled = false, description = "Trigger create2 function to deploy test contract "
      + "using Executive account")
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethed.cdBalanceForReceiver(fromAddress, 9000_000_000_000L, 0, 1,
        ByteString.copyFrom(executiveAddress001), testKey002, blockingStubFull));
    ...
    accountResource = PublicMethed.getAccountResource(executiveAddress001, blockingStubFull);
    long userUcrLimitBefore = accountResource.getUcrLimit();
    long userUcrUsageBefore = accountResource.getUcrUsed();
    long userBalanceBefore = PublicMethed.queryAccount(executiveAddress001, blockingStubFull)
        .getBalance();
    ...
    final String triggerTxid = PublicMethed.triggerContract(factoryContractAddress,
        ...
        1000000000L, "0", 0, executiveAddress001, executiveKey001,
        blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    long userBalanceAfter = PublicMethed.queryAccount(executiveAddress001, blockingStubFull)
        .getBalance();
  ...
  public void test03TriggerTestContract() {
    ...
    Assert.assertTrue(PublicMethed.cdBalanceForReceiver(fromAddress,
        PublicMethed.getCdBalanceCount(executiveAddress001, executiveKey001, 50000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(executiveAddress001), testKey002, blockingStubFull));
    ...
    PublicMethed.unCdBalance(fromAddress, testKey002, 0,
        dev001Address, blockingStubFull);
    PublicMethed.unCdBalance(fromAddress, testKey002, 1,
        executiveAddress001, blockingStubFull);
    PublicMethed.unCdBalance(fromAddress, testKey002, 0,
        executiveAddress001, blockingStubFull);
