...
public class ContractSrcToken078 {
  ...
  public void testOriginCall001() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractSrcToken078.sol";
    ...
    String filePath1 = "./src/test/resources/soliditycode/contractSrcToken078.sol";
    ...
    String filePath2 = "./src/test/resources/soliditycode/contractSrcToken078.sol";
    ...
    AccountResourceMessage resourceInfo1 = PublicMethed.getAccountResource(internalTxsAddress,
        blockingStubFull);
    logger.info("getUcrUsed  " + resourceInfo1.getUcrUsed());
    logger.info("getUcrLimit  " + resourceInfo1.getUcrLimit());
