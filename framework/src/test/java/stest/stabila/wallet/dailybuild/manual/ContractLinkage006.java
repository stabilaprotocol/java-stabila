...
public class ContractLinkage006 {
  ...
  public void teststackOutByContract() {
    ...
    Assert.assertTrue(PublicMethed.cdBalance(linkage006Address, 1000000L,
        0, linkage006Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethed.cdBalanceGetUcr(linkage006Address, 1000000L,
    ...
    //success ,balnace change.use UcrUsed and NetUsed
    ...
    PublicMethed.unCdBalance(linkage006Address, linkage006Key, 1,
  ...
  public void teststackOutByContract1() {
    Assert.assertTrue(PublicMethed.sendcoin(linkage006Address2, 20000000000L, fromAddress,
        testKey003, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethed.cdBalance(linkage006Address2, 1000000L,
        0, linkage006Key2, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethed.cdBalanceGetUcr(linkage006Address2, 1000000L,
    ...
    //success ,balance change.use UcrUsed and NetUsed
    ...
    Assert.assertTrue((beforeUcrUsed1 + ucrUsed1) >= afterUcrUsed1);
  ...
  public void teststackOutByContract2() {
    ...
    //failed ,use UcrUsed and NetUsed
    txid = PublicMethed.triggerContract(contractAddress,
        "init(address,uint256)", initParmes, false,
    ...
    Assert.assertTrue((beforeUcrUsed2 + ucrUsed2) >= afterUcrUsed2);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    Assert.assertTrue(infoById.get().getResultValue() == 1);
    PublicMethed.unCdBalance(linkage006Address2, linkage006Key2, 1,
  ...
  public void shutdown() throws InterruptedException {
    PublicMethed.unCdBalance(linkage006Address, linkage006Key, 1,
        linkage006Address, blockingStubFull);
    PublicMethed.unCdBalance(linkage006Address, linkage006Key, 0,
        linkage006Address, blockingStubFull);
    PublicMethed.unCdBalance(linkage006Address2, linkage006Key2, 1,
        linkage006Address2, blockingStubFull);
    PublicMethed.unCdBalance(linkage006Address2, linkage006Key2, 0,
        linkage006Address2, blockingStubFull);
