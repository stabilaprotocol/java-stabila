package stest.stabila.wallet.dailybuild.svmnewcommand.batchValidateSignContract;
...
public class batchValidateSignContract007 {
  ...
  public void test01Constructor() {
    ...
    Long ucrUsed1 = infoById.get().getReceipt().getUcrUsage();
    Long netFee1 = infoById.get().getReceipt().getNetFee();
    long ucrUsageTotal1 = infoById.get().getReceipt().getUcrUsageTotal();
    ...
    Assert.assertTrue(beforeUcrUsed + ucrUsed1 + ucrUsed2 >= afterUcrUsed);
