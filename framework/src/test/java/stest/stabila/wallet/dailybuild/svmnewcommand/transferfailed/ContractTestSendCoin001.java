...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertTrue(PublicMethed.cdBalanceForReceiver(fromAddress,
        PublicMethed.getCdBalanceCount(dev001Address, dev001Key, 130000L, blockingStubFull), 0,
    ...
    String filePath = "src/test/resources/soliditycode/contractSrcToken031.sol";
    ...
    Assert.assertEquals("contract validate error : Cannot transfer STB to a smartContract.",
