...
contract transferTokenTestA {
    ...
    constructor(address payable toAddress, uint256 tokenValue, srcToken id) payable public{
    ...
    function transferTokenTest(address payable toAddress, uint256 tokenValue, srcToken id) payable public    {
        toAddress.transferToken(tokenValue, id);
    }
    ...
    function createContractTest(uint256 tokenValue, srcToken id) payable public returns(address){
        Simple s = new Simple();
    ...
    function revertCreateContractTest(uint256 tokenValue, srcToken id) payable public {
        Simple s = new Simple();
        address(s).transferToken(tokenValue, id);
        revert();
    }
...
contract transferTokenTestC {
    ...
    constructor(srcToken id) payable public{
        s = new Simple();
