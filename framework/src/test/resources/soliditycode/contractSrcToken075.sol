...
contract Dest {
 ...
 function getToken(srcToken tokenId) payable public{
 ...
 function getTokenLongMin() payable public{
        // long.min - 1000020
 emit logGetToken(msg.sender.tokenBalance(srcToken(uint256(int256(-9223372036855775828)))), msg.tokenid, msg.tokenvalue, msg.value);
 }

 function getTokenLongMax() payable public{
        // long.max + 1000020
 emit logGetToken(msg.sender.tokenBalance(srcToken(9223372036855775827)), msg.tokenid, msg.tokenvalue, msg.value);
 }
