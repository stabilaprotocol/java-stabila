...
function uint256ToSrctoken(address toAddress,uint256 tokenValue, uint256 tokenInt)  public {
  srcToken t = srcToken(tokenInt); // OK
  toAddress.transferToken(tokenValue, t); // OK
  toAddress.transferToken(tokenValue, tokenInt); // OK
}

function addressToSrctoken(address toAddress, uint256 tokenValue, address adr) public {
...
function bytes32ToSrctoken(address toAddress, uint256 tokenValue, bytes32 b32) public {
