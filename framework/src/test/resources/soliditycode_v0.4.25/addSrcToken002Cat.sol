...
contract KittyBreeding is KittyOwnership {
    ...
    uint256 public autoBirthFee = 2 unit;
    ...
    ///  period has passed.
    function _isReadyToGiveBirth(Kitty _mastabila) private view returns (bool) {
    ...
    function _breedWith(uint256 _mastabilaId, uint256 _sireId) internal {
        ...
        Pregnant(kittyIndexToOwner[_mastabilaId], _mastabilaId, _sireId, mastabila.cooldownEndBlock);
    }
...
contract KittyMinting is KittyAuction {
    ...
    uint256 public constant GEN0_STARTING_PRICE = 10 unit;
...
contract KittyCore is KittyMinting {
    ...
    function unpause(address toAddress, uint256 tokenValue, srcToken tokenId) public onlyCEO whenPaused returns (uint256 r) {
