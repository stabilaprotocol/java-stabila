...
contract Dest {
 ...
 function Dest() payable public {}
    ...
    function getToken(srcToken tokenId) payable {
        logGetToken(msg.sender.tokenBalance(tokenId), msg.tokenid, msg.tokenvalue, msg.value);
 }

    function getTokenLongMin() payable {
        // long.min - 1000020
 logGetToken(msg.sender.tokenBalance(srcToken(-9223372036855775828)), msg.tokenid, msg.tokenvalue, msg.value);
 }

    function getTokenLongMax() payable {
        // long.max + 1000020
 logGetToken(msg.sender.tokenBalance(srcToken(9223372036855775827)), msg.tokenid, msg.tokenvalue, msg.value);
 }
