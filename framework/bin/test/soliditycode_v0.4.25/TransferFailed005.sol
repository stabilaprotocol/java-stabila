contract UcrOfTransferFailedTest {
    ...
    function testCallStbInsufficientBalance(uint256 i,address caller) public returns (bool){
    ...
    function testSendStbNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
        nonexistentTarget.send(i);
    }

    function testTransferStbNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
    ...
    function testCallStbNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
