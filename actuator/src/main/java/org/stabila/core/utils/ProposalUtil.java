...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] STB
    ASSET_ISSUE_FEE(4), // 1024 STB, [0, 100000000000] STB
    WITNESS_PAY_PER_BLOCK(5), // 16 STB, [0, 100000000000] STB
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 STB, [0, 100000000000] STB
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] STB
