...
public class MarketUtils {
  ...
  /**
   * ex.
   * for sellToken is A, buyToken is STB.
   * price_A_maker * sellQuantity_maker = Price_STB * buyQuantity_maker
   * ==> price_A_maker = Price_STB * buyQuantity_maker/sellQuantity_maker
   *
  ...
  public static boolean priceMatch(MarketPrice takerPrice, MarketPrice makerPrice) {
    // for takerPrice, buyToken is A,sellToken is STB.
    // price_A_taker * buyQuantity_taker = Price_STB * sellQuantity_taker
    // ==> price_A_taker = Price_STB * sellQuantity_taker/buyQuantity_taker

    // price_A_taker must be greater or equal to price_A_maker
    // price_A_taker / price_A_maker >= 1
    // ==> Price_STB * sellQuantity_taker/buyQuantity_taker >= Price_STB * buyQuantity_maker/sellQuantity_maker
